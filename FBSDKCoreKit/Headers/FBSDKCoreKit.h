...
#define FBSDK_VERSION_STRING @"4.44.0"
...
/*!
 ...
 [FBSDKAppEvents setPushNotificationsDeviceTokenString:@"3072D3542022EF94CBDABD464E0DCCEB"];
 
 [FBSDKAppEvents setFlushBehavior:(FBSDKAppEventsFlushBehaviorAuto)];
 
 [FBSDKAppEvents setUserID:@"9FAB691BCB4C0C651D047D4645094117"];
 
 [FBSDKAppEvents clearUserID];
 
 [FBSDKAppEvents logEvent:@"login"];
 
 [FBSDKAppEvents logPurchase:100 currency:@"CNY"];
 
 [FBSDKProfile loadCurrentProfileWithCompletion:nil];
